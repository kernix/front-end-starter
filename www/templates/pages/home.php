  ...
  <div class="container container-sm">
    <div class="default-figure">
      <div class="default-figure-video ratio ratio-16x9">
        <a href="javascript:void(0)" class="iframe-placeholder" style="background-image: url('https://source.unsplash.com/790x445')"><span class="visually-hidden">Jouer la vidéo</span></a>
      ...
      <div class="swiper-wrapper">
        ...
        <?php for ($j=0; $j < 6; $j++): ?>
          <a href="https://www.youtube.com/watch?v=CHk5SWVO4p8" data-lity class="swiper-slide video-item" >
            <div class="video-img" style="background-image: url('https://source.unsplash.com/760x56<?= $j ?>')"></div>
